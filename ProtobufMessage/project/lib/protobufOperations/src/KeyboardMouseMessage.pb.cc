...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_KeyboardMouseMessage_2eproto = {
  false, false, 127, descriptor_table_protodef_KeyboardMouseMessage_2eproto, "KeyboardMouseMessage.proto", 
  &descriptor_table_KeyboardMouseMessage_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_KeyboardMouseMessage_2eproto::offsets,
  file_level_metadata_KeyboardMouseMessage_2eproto, file_level_enum_descriptors_KeyboardMouseMessage_2eproto, file_level_service_descriptors_KeyboardMouseMessage_2eproto,
};
...
template<> PROTOBUF_NOINLINE ::KeyboardMouse::ButtonsCoords* Arena::CreateMaybeMessage< ::KeyboardMouse::ButtonsCoords >(Arena* arena) {
