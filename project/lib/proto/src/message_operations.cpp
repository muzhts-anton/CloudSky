...
SendInteraction::SendInteraction(std::string file_path, keyboard_mouse::buttons_coords message_1) : InteractionOperations(message_1)
{
...
SendInteraction::SendInteraction(std::string file_path, bool button_pressed[button_quanity], int coords[2]) : InteractionOperations(button_pressed, coords)
{
    out.open(file_path, std::ios_base::binary);
    if (!out)
    {
...
ReceiveInteraction::ReceiveInteraction(std::string file_path, keyboard_mouse::buttons_coords message_1) : InteractionOperations(message_1)
{
